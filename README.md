# magTAWSSPP
This is a post-processing for magnitude of time average of wall shear stress written based on foam-extend-4.1.


## Mathematical Relationships
$$ magTAWSS = {1 \over T} \int_0^T \mid WSS \mid \ dt $$

Which $magTAWSS$, $T$, $WSS$, and $t$ are magnitude of time average of wall shear stress, period, wall shear stress, and time, respectively.


## Installation
It is working on foam-extend-4.1
```bash
git clone https://github.com/EhsanGLB/magTAWSSPP.git
cd magTAWSSPP/magTAWSSPP
wmake
cd ../case
```
